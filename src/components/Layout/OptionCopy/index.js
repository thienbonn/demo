...
function OptionCopy() {
    ...
    useEffect(() => {
        ...
        const position = document.querySelector(".pageOne_Wrapper_Option_copy__pdoWn")
        const edit = document.querySelector(".pageOne_Main_One__evO94")
